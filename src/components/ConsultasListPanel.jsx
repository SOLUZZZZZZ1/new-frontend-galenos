...
/**
 * Panel izquierdo con filtros + lista de consultas de De guardia.
 */
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <input
            ...
            placeholder="Buscar por título, síntoma, especialidad…"
      ...
      <div className="flex-1 min-h-[260px] max-h-[560px] overflow-y-auto space-y-2">
        {(!cases || cases.length === 0) && (
          <p className="text-xs text-slate-500">
            No hay consultas que coincidan con los filtros. Crea una nueva consulta de diagnóstico
            o ajusta los filtros de la cartelera.
          </p>
        )}
